...
ia_income <- get_acs(
  ...
  state = "IA",
  year = 2021,
  geometry = TRUE             # US Census Cartographic Boundary geometry data by default. Can specify TIGER/Line 
)
...
sqrt(144)           # Calculate the square root of the input
round(3.14159, 3)   # Round the first input, to the number of places in the second
floor(3.14159)      # Find the first integer less than the input
ceiling(3.14159)    # Find the first integer greater than the input
...
helloFunction <- function() {         # The function is named hello_function
  print("Hello world!")               # It returns "Hello world" as output
}
